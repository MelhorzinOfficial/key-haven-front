 ...
 *
 * The slider adapts to horizontal or vertical orientation and allows for custom styling and configuration. Multiple thumbs are rendered if the `value` or `defaultValue` props are arrays.
 *
